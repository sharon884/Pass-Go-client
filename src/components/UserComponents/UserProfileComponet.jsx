...
        // New styles for Referral Code
        referralCodeBg: "bg-indigo-50 border-indigo-200",
        referralCodeText: "text-indigo-800",
        referralCopyButton: "bg-indigo-200 hover:bg-indigo-300 text-indigo-700",
      }
    } else {
      return {
...
        // New styles for Referral Code
        referralCodeBg: theme?.colors?.inputBg || "bg-gray-700",
        referralCodeText: theme?.colors?.primaryAccent || "text-blue-400",
        referralCopyButton: "bg-gray-600 hover:bg-gray-500 text-white",
      }
    }
  }
...
  }, [])
  
  // New function to handle copying the referral code
...
          </button>
        </div>
        {/* The user data must be present to continue rendering */}
      </div>
    )
  }
...
                  </div>
                  
                  {/* REFERRAL CODE STYLING - FIX APPLIED HERE */}
                  {user.referralCode && (
                    <div>
                      <label className={`block text-sm font-medium ${styles.textMuted} mb-1 flex items-center`}>
                        <svg className={`w-4 h-4 mr-1 ${styles.iconColor}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V9a2 2 0 012-2h10a2 2 0 012 2v2m-7 4h1a2 2 0 002-2v-3a2 2 0 00-2-2H9a2 2 0 00-2 2v3a2 2 0 002 2z" />
                        </svg>
                        Your Referral Code
                      </label>
                      <div 
                        className={`flex items-center justify-between rounded-lg border ${styles.cardBorder} p-1 pr-2`}
                        style={{
                          background: currentTheme === "classic" ? styles.referralCodeBg : theme?.colors?.inputBg || "#4b5563",
                        }}
                      >
                        <p
                          className={`font-mono text-lg font-semibold px-3 py-2 rounded-lg truncate ${styles.referralCodeText}`}
                        >
                          {user.referralCode}
                        </p>
                        <button
                          onClick={copyReferralCode}
                          className={`flex-shrink-0 p-2 ml-2 rounded-md transition-colors ${styles.referralCopyButton}`}
                        >
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7v4a1 1 0 001 1h4a1 1 0 001-1V7m0 0V4a1 1 0 00-1-1H9a1 1 0 00-1 1v3m8 4v7a1 1 0 01-1 1h-7a1 1 0 01-1-1v-7m7 0H9" />
                          </svg>
                        </button>
                      </div>
                    </div>
