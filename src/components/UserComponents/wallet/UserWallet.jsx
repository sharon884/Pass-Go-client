    ...
    return (
      ...
      >
        ...
        <div className="text-center max-w-md">
          <h2 className={`text-xl sm:text-2xl font-bold ${styles.textPrimary} mb-3`}>Loading Wallet</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className={`mt-1 text-sm sm:text-base ${styles.textMuted}`}>
                  Manage your balance and view transaction history in one place.
                </p>
              </div>
              {/* Summary Stats */}
        ...
        {wallet ? (
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-4 sm:space-y-0">
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  ></div>
                  <span className={`text-xs sm:text-sm ${styles.textMuted} font-medium`}>Available</span>
                </div>
              </div>
              <div
          ...
          >
            ...
            <h3 className={`text-lg sm:text-xl font-semibold ${styles.textPrimary} mb-2`}>Wallet Not Available</h3>
            <p className={`${styles.textMuted} text-sm sm:text-base`}>Wallet information not available at this time.</p>
          </div>
        )}
