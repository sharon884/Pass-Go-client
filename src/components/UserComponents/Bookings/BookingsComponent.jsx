...
const BookingsComponent = () => {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        const { orders: fetchedOrders, tickets: fetchedTickets } =
  ...
  if (loading) {
    return (
      ...
      >
        ...
        <h2 className={`text-xl font-semibold ${styles.textSecondary}`}>
          ...
          <div
            ...
            style={{
              background:
                currentTheme === "classic"
                  ? "#ffffff"
                  : theme?.colors?.cardBg || "#1f2937",
            }}
          >
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <h2
                  className={`text-2xl sm:text-3xl font-bold ${styles.textPrimary} flex items-center`}
                >
                  <svg
                ...
                <p className={`mt-1 text-sm sm:text-base ${styles.textMuted}`}>
                  View and manage all your event bookings and tickets in one
                  place.
                </p>
              </div>
                    ...
                    {filteredBookings.map((booking) => (
                      ...
                      >
                        <td className="px-4 py-4">
                          <div className="flex items-center">
                            <div className="flex-shrink-0 h-12 w-12">
                              {booking.eventImages?.[0] ? (
                                <img
                                  ...
                                  src={
                                    booking.eventImages[0] || "/placeholder.svg"
                                  }
                            ...
                            <div className="ml-4 min-w-0 flex-1">
                              <div
                                className={`text-sm font-medium ${styles.textPrimary} truncate`}
                              >
                                {booking.eventTitle || "Event not found"}
                              </div>
                              <div
                                className={`text-sm ${styles.textMuted} truncate`}
                              >
                        ...
                        <td className="px-4 py-4 whitespace-nowrap">
                          <div
                            className={`text-sm ${styles.textPrimary} font-medium`}
                          >
                        ...
                        <td className="px-4 py-4 whitespace-nowrap">
                          {booking.bookingType === "order" ? (
                            <div>
                              <div
                                className={`text-sm ${styles.textPrimary} font-semibold`}
                              >
                                ₹{booking.amount || 0}
                              </div>
                              {booking.gstAmount && (
                        ...
                        <td
                          className={`px-4 py-4 whitespace-nowrap text-sm ${styles.textMuted}`}
                        >
                ...
                >
                      ...
                      <div className="flex items-center space-x-3 flex-1 min-w-0">
                        <div className="flex-shrink-0">
                          {booking.eventImages?.[0] ? (
                            ...
                            <div className="h-12 w-12 bg-indigo-100 rounded-lg flex items-center justify-center text-indigo-600 font-semibold">
                              {booking.eventTitle?.charAt(0).toUpperCase() ||
                                "E"}
                            </div>
                          )}
                        </div>
                        <div className="flex-1 min-w-0">
                          <h3
                            className={`text-base font-medium ${styles.textPrimary} truncate`}
                          >
                            {booking.eventTitle || "Event not found"}
                          </h3>
                  ...
                  <div className="px-4 py-4 space-y-3">
                    ...
                    <div className="flex items-center text-sm">
                      ...
                      <span className={`${styles.textMuted} ml-2`}>
                        {formatTime(booking.eventTime)}
                      </span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2 flex-1 min-w-0">
                        ...
                        <span
                          className={`text-xs ${styles.textMuted} truncate`}
                        >
                          {booking.eventCategory}
                        </span>
                      </div>
                      <div className="text-right flex-shrink-0">
                        {booking.bookingType === "order" ? (
                          <div>
                            <div
                              className={`text-lg font-semibold ${styles.textPrimary}`}
                            >
                              ₹{booking.amount || 0}
                            </div>
                            {booking.gstAmount && (
