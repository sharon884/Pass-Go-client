...
              <div
                // 🛑 CHANGE: Updated transition for the Fluid Reveal effect 🛑
                className={`text-center transition-all duration-700 ease-out transform ${
                  isVisible 
                    ? "translate-y-0 opacity-100 scale-100 blur-0" // Final state: clear, in place
                    : "translate-y-6 opacity-0 scale-98 blur-md" // Initial state: slightly lower, blurry, faded
                }`}
              >
                {/* Quote icon */}
