    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm text-gray-500">Manage your host account and event hosting preferences.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-center">
              ...
              <p className="text-gray-600 mb-4">{host.email}</p>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-900 font-medium bg-gray-50 px-4 py-3 rounded-lg border">{host.name}</p>
                  </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <button
                    onClick={() => navigate("/host/Edit-Profile-Host")}
                  ...
                  <button
                    ...
                    className="bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 py-3 px-6 rounded-lg font-medium transition-colors flex items-center justify-center"
                  >
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                        strokeLinecap="round"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="font-medium text-indigo-900">Create Events</h4>
                  <p className="text-sm text-indigo-700">Host amazing events</p>
                </div>
              </div>
            </div>
            <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="font-medium text-indigo-900">Analytics</h4>
                  <p className="text-sm text-indigo-700">Track event performance</p>
                </div>
              </div>
            </div>
            <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="font-medium text-indigo-900">Revenue</h4>
                  <p className="text-sm text-indigo-700">Manage earnings</p>
                </div>
              </div>
            </div>
          </div>
