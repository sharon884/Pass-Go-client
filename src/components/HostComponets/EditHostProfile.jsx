      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mt-6 bg-indigo-50 border border-indigo-200 rounded-lg p-4">
          <div className="flex items-start">
            ...
            <div>
              <h4 className="text-sm font-medium text-indigo-800 mb-1">Host Profile Tips</h4>
              <ul className="text-sm text-indigo-700 space-y-1">
                <li>• Use a professional profile picture to build trust with attendees</li>
                <li>• Keep your mobile number updated for event coordination</li>
                <li>• Profile images should be clear and under 5MB in size</li>
                <li>• Complete verification to unlock all host features</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-200 rounded-lg p-4">
          <div className="flex items-start">
            ...
            <div>
              <h4 className="text-sm font-medium text-indigo-800 mb-1">Host Benefits</h4>
              <p className="text-sm text-indigo-700">
                As a verified host, you can create events, manage bookings, track analytics, and earn revenue through
                the PassGo platform.
              </p>
            </div>
          </div>
