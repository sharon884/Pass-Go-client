...
const AdminWallet = () => {
  ...
  // Define columns for the admin wallet transactions table
  const adminWalletTransactionColumns = [
    {
      header: "Date",
      accessor: "createdAt",
      render: (createdAt) => (
    ...
    return (
      ...
      >
        ...
        <div className="text-center max-w-md">
          <h2 className={`text-xl sm:text-2xl font-bold ${styles.textPrimary} mb-3`}>Loading Admin Wallet</h2>
          <p className={`${styles.textMuted} text-sm sm:text-base`}>
            Please wait while we fetch your admin wallet information...
          </p>
          <div
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className={`mt-1 text-sm sm:text-base ${styles.textMuted}`}>
                  Manage platform finances and view all transaction activities in one place.
                </p>
              </div>
              {/* Summary Stats */}
        ...
        {wallet ? (
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-4 sm:space-y-0">
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  ></div>
                  <span className={`text-xs sm:text-sm ${styles.textMuted} font-medium`}>Platform Revenue</span>
                </div>
              </div>
              <div
          ...
          >
            ...
            <h3 className={`text-lg sm:text-xl font-semibold ${styles.textPrimary} mb-2`}>
              Admin Wallet Not Available
            </h3>
            <p className={`${styles.textMuted} text-sm sm:text-base`}>
              Admin wallet information not available at this time.
            </p>
          </div>
        )}
        ...
        >
          ...
          <ThemedTable columns={adminWalletTransactionColumns} data={transactions} themeStyles={styles} />
        </div>
      </div>
