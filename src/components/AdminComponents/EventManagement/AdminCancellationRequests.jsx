        ...
        {requests.map((req) => (
          ...
          >
            <div style={{ display: "flex", gap: "1rem" }}>
              {/* Event Image */}
              {req.event?.bannerImage && (
                <img
                  src={req.event.bannerImage}
                  alt="Event Banner"
                  style={{
                    width: "150px",
                    height: "100px",
              ...
              <div style={{ flex: 1 }}>
                ...
                <p>
                  <b>Date:</b>{" "}
                  {new Date(req.event?.startDate).toLocaleDateString()} -{" "}
                  {new Date(req.event?.endDate).toLocaleDateString()}
                </p>
                <p>
              ...
              <div style={{ minWidth: "200px", textAlign: "center" }}>
                {req.host?.profileImage && (
                  <img
                    src={req.host.profileImage}
                    alt="Host"
                    style={{
                      width: "80px",
                      height: "80px",
